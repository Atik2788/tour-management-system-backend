...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield axios_1.default.post(env_1.envVars.SSL.SSL_PAYMENT_API, data, { headers: { "Content-Type": "application/x-www-form-urlencoded" } });
        return response.data;
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
    }
    catch (error) {
        console.log("Payment error occured", error);
        throw new appError_1.default(201, error.message);
    }
});
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield payment_model_1.Payment.updateOne({ transactionId: payload.tran_id }, { paymentGetwayData: response.data }, { runValidators: true });
    }
    catch (error) {
        console.log(error);
        throw new appError_1.default(400, `Payment validation error occured ${error.message}`);
    }
});
exports.SSLService = { sslPaymentInit, validatePayment };
